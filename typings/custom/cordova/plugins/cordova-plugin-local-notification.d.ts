 ...
 */
interface CordovaPluginLocalNotification {

  /**
   * Schedule a single push notification
   */
  schedule(notificationData: ICordovaPluginLocalNotificationLocalNotification): void;
  /**
   * Schedule multiple push notifications
   */
  schedule(notificationData: Array<ICordovaPluginLocalNotificationLocalNotification>): void;
  /**
   ...
   */
  on(eventType: string, callback?: (notification?) => void): void;
  /**
   * Update a single scheduled local notification
   */
  update(notificationData: ICordovaPluginLocalNotificationLocalNotification): void;
  /**
   * Update multiple scheduled local notifications
   */
  update(notificationData: Array<ICordovaPluginLocalNotificationLocalNotification>): void;
  /**
   ...
   */
  clearAll(callback?: () => void, scope?) : void;
  /**
   ...
   */
  cancelAll(callback?: () => void, scope?): void;
  /**
   ...
   */
  get(id: number, callback: (notification: ICordovaPluginLocalNotificationLocalNotification) => void): void;
  /**
   * Get multiple local notifications
   */
  get(id: Array<number>, callback: (notification: ICordovaPluginLocalNotificationLocalNotification) => void): void;
  /**
   * Get a single scheduled local notification
   */
  getScheduled(id: number, callback: (notification: ICordovaPluginLocalNotificationLocalNotification) => void): void;
  /**
   * Get a single triggered local notification
   */
  getTriggered(id: number, callback: (notification: ICordovaPluginLocalNotificationLocalNotification) => void): void;
  /**
...
interface CordovaPluginNotification {
  ...
  local: CordovaPluginLocalNotification;
}